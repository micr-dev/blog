...
Getting back to the topic, I decided to run
[Octen's](https://github.com/Octen-Team/benchmark) own benchmark with the
spare free credits that I had left, since I had everything set up and it
wouldn't be much work.

14/08/2026 Edit: As per Octen's team, this benchmark is mainly focused on testing latency, not results; though I think it also works quite well for testing the latter, even if it wasn't designed with that objective in mind.
